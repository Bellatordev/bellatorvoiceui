...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#1a1a24] w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-[#1a1a24] blur-2xl"></div>
        ...
        <div className="absolute inset-auto z-40 h-44 w-full -translate-y-[12.5rem] bg-[#1a1a24]"></div>
      </div>

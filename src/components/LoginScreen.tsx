...
const LoginScreen: React.FC<LoginScreenProps> = ({
  ...
  return <div className="max-w-md w-full mx-auto relative z-20 bg-gray-950/30 dark:bg-gray-900/30 p-8 rounded-xl backdrop-blur-sm border border-white/10">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Button type="submit" disabled={isLoading} className="w-full font-playfair bg-premium-accent hover:bg-premium-accent/90 text-white dark:text-white font-bold">

      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="space-y-2">
          ...
          <Input
            ...
            className="bg-[#282838] border-gray-700 text-white font-sans placeholder:text-gray-500 rounded-md"
            required
          />
        </div>
        ...
        <Button 
          type="submit" 
          className="w-full py-6 rounded-md bg-[#9583f4] hover:bg-[#8070e6] text-white font-medium font-sans text-lg"
          disabled={isLoading}
        >
